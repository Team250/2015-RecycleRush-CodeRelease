 ...
 *
 */
public class _ElevatorMotorUp extends Command {

	public _ElevatorMotorUp() {
	...
	protected void execute() {
		if (Robot.gripper.isGripperClosed()) {
			Robot.elevator.setSpeed(RobotMap.kELEVATOR_MANUAL_UP_LOADED_SPEED);
		} else {
			Robot.elevator.setSpeed(RobotMap.kELEVATOR_MANUAL_UP_UNLOADED_SPEED);
		}
	}
